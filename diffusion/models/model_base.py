...
class BasicModel(VeryBasicModel):
    def __init__(self, 
                 ...
                 optimizer_kwargs={'lr':1e-4, 'weight_decay':1e-2}, # 'lr':1e-3, 'weight_decay':1e-2
                 lr_scheduler= None, 
                 lr_scheduler_kwargs={},
                 use_scheduler = True,
                 ):
    ...
    #         scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[50, 200], gamma=0.1)
    #         scheduler = [
    #             {
    #                 'scheduler': scheduler,
    #                 'interval': 'epoch',
